...
('卡布奇诺', '绵密奶泡与浓缩咖啡的经典组合', 26.00, 'coffee', 'https://images.unsplash.com/photo-1572442388796-11668a67e53d?q=80&w=600&auto=format&fit=crop'),
('摩卡咖啡', '巧克力与咖啡的甜蜜邂逅', 30.00, 'coffee', 'https://images.unsplash.com/photo-1514432324607-a09d9b4aefdd?q=80&w=600&auto=format&fit=crop'),
...
('芝士蛋糕', '浓郁奶香，入口即化', 33.00, 'dessert', 'https://images.unsplash.com/photo-1533134242443-d4fd215305ad?q=80&w=600&auto=format&fit=crop');

-- 预置示例收藏记录 (testuser 收藏了 5 件商品)
